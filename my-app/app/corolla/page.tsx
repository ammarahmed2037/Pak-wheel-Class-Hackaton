    ...
    return(
        <div>
            <div className="flex flex-col justify-center items-center my-2">
                <h1 className="font-extrabold my-2">TOYATA COROLLA PRICE IN PAKISTAN, IMAGES, REVIEWS & SPECS.</h1>
            ...
            <div>
                ...
                <h1 className="font-bold text-center text-green-500 my-3">PKR: 50,00,000</h1>
