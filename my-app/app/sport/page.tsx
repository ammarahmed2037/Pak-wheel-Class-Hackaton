    ...
    return(
        <div>
            <div className="flex flex-col justify-center items-center my-2">
                <h1 className="font-extrabold my-2">SPORTS CAR PRICE IN PAKISTAN, IMAGES, REVIEWS & SPECS.</h1>
                <Image src="/sports.jpg" alt="sports image" width={300} height={500} />
            </div>
            ...
            <div>
                ...
                <div className="flex gap-6 justify-center items-center">
                    <h1><b>Avg:</b> 13 km pr hr</h1>
                    <h1><b>Transmission:</b> Automatic</h1>
                    <h1><b>Fuel Type:</b> High Octane</h1>
                </div>

                <h1 className="font-bold text-center text-green-500 my-3">PKR: 80,00,000</h1>
