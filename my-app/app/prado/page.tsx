    ...
    return(
        <div>
            <div className="flex flex-col justify-center items-center my-2">
                <h1 className="font-extrabold my-2">TOYATA PRADO PRICE IN PAKISTAN, IMAGES, REVIEWS & SPECS.</h1>
            ...
            <div>
                ...
                <div className="flex gap-6 justify-center items-center my-2">
                    ...
                    <h1><b>Engine:</b> 2200 CC</h1>
                    <h1><b>Condition:</b> 10/10</h1>
                    <h1><b>Driven:</b> 9500 km</h1>
                    <h1><b>Suspension Type:</b> Soft Suspension</h1>
                    <h1><b>Number Of Doors:</b> 4</h1>
                </div>
                <div className="flex gap-6 justify-center items-center">
                    <h1><b>Avg:</b> 20 km pr hr</h1>
                    <h1><b>Transmission:</b> Automatic</h1>
                    <h1><b>Fuel Type:</b> High Octane</h1>
                </div>

                <h1 className="font-bold text-center text-green-500 my-3">PKR: 1,50,00,000</h1>
