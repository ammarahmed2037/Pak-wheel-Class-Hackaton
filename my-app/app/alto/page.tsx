    ...
    return(
        <div>
            <div className="flex flex-col justify-center items-center my-2">
                <h1 className="font-extrabold my-2">SUZUKI ALTO PRICE IN PAKISTAN, IMAGES, REVIEWS & SPECS.</h1>
            ...
            <div>
                ...
                <div className="flex gap-6 justify-center items-center my-2">
                    ...
                    <h1><b>Engine:</b> 800 CC</h1>
                    <h1><b>Condition:</b> 8.5/10</h1>
                    <h1><b>Driven:</b> 7500 km</h1>
                ...
                <h1 className="font-bold text-center text-green-500 my-3">PKR: 25,00,000</h1>
